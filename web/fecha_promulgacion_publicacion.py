...
esMetaData=False #si es falso buscará la URL del XML de la norma full en vez de la URL que solo tienen metadadata de la norma


def busca_datos(esMetaData,esRecurisivo=False):
    ...
    try:  #Si hay un error en la respuesta de BCN, pruena con el otro ULR y si vuelve a falla, devuele nulos
        ...
        if esRecurisivo:  
            return {
                ...
                return (busca_datos(not esMetaData, True))
